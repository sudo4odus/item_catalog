...
course = Courses(title='Natural Language Processing',
                 ...
                 process, and manipulate human language. Build models
                 on real data, and get hands-on experience with
...
course = Courses(title='Data Engineer',
                 ...
                 Big Data. Enroll now to build production-ready data
                 infrastructure, an essential skill for advancing your
                 data career.''',
                 programs=program2,
                 )
session.add(course)
...
course = Courses(title='Predictive Analytics for Business',
                 ...
                 business intelligence to solve real-world business
                 problems''',
                 programs=program2,
                 )
session.add(course)
...
course = Courses(title='Cloud Developer',
                 ...
                 an essential skill for advancing your web
                 development career.''',
                 programs=program3,
                 )
session.add(course)
...
course = Courses(title='Cloud Dev Ops Engineer',
                 ...
                 competitive in this agile world. Enroll now to operationalize
                 infrastructure at scale and deliver applications and services
                 at high velocity, an essential skill for advancing
                 your career.''',
                 programs=program3,
                 )
session.add(course)
...
course = Courses(title='C++ Developer',
                 ...
                 the world's most exciting engineering jobs -- from
                 self-driving cars and robotics, to web browsers,
                 media platforms, servers, and even video games.''',
                 programs=program4,
                 )
session.add(course)
session.commit()
...
course = Courses(title='Full Stack Developer',
                 ...
                 Web Developer, and learn to create complex server-side
                 web applications that use powerful relational databases
...
course = Courses(title='Blockchain Developer',
                 ...
                 protocols, build projects for real-world application,
                 and gain the essential skills for a career in this
                 dynamic space.''',
                 programs=program4,
                 )
session.add(course)
...
course = Courses(title='Robotics Software Engineer',
                 ...
                 software engineering skills: ROS, Gazebo, Localization,
                 Mapping, SLAM, Navigation, and Path Planning.''',
                 programs=program5,
                 )
session.add(course)
session.commit()
...
course = Courses(title='Self Driving Car Engineer',
                 ...
                 on the cutting-edge of robotics, machine learning,
                 and engineering. Learn the skills and techniques used
                 by self-driving car teams at the most advanced technology
...
course = Courses(title='Business Analytics',
                 ...
                 and communicate your findings with SQL, Excel,
                 and Tableau.''',
                 programs=program6,
                 )
session.add(course)
...
course = Courses(title='Predictive Analytics for Business',
                 description='''Learn to apply predictive analytics and
                 business intelligence to solve real-world
                 business problems''',
                 programs=program6,
                 )
session.add(course)
